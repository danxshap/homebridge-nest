    ...
    updateData(device, structure) {
        ...
        if (device && this.accessory) {
            ...
            if (previousActive !== currentActive) {
                this.log.debug('Temperature sensor ' + this.device.name + ' active state changed from Nest: ' + currentActive);
                
                // If this sensor became active, handle mutual exclusivity with other sensors
                if (currentActive && this.conn && this.conn.handleNestActiveSensorChange) {
                    this.conn.handleNestActiveSensorChange(this.device.thermostat_device_id, this.device.device_id, 'sensor');
                }
