...
class NestTempSensorAccessory extends NestDeviceAccessory {
    ...
    updateData(device, structure) {
        ...
        if (device && this.accessory) {
            ...
            // Always log the values to debug the issue
            this.log.info('Temperature sensor ' + this.device.name + ' updateData: previousActive=' + previousActive + ', currentActive=' + currentActive);
            ...
            if (previousActive !== currentActive) {
                ...
                if (sensorSwitchService) {
                    this.log.info('Updating switch for ' + this.device.name + ' to: ' + currentActive);
