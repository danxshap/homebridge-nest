...
class NestThermostatAccessory extends NestDeviceAccessory {
    ...
    setActiveStatus(state, callback) {
        ...
        this.setPropertyAsync('rcs_settings', 'active_rcs_sensors', {thermostat: this.device.device_id, sensor: null, state: state}, 'active sensor switch').asCallback(callback);
    }
    ...
    updateData(device, structure) {
        ...
        if (device && this.accessory) {
            ...
            if (previousActive !== currentActive) {
                ...
                if (switchService) {
                    this.log.debug('Updating thermostat sensor switch state from Nest: ' + currentActive);
