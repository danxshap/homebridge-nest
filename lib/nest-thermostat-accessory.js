    ...
    updateData(device, structure) {
        ...
        if (device && this.accessory) {
            ...
            if (previousActive !== currentActive) {
                this.log.debug('Thermostat ' + this.device.name + ' active sensor state changed from Nest: ' + currentActive);
                
                // If thermostat became active sensor, handle mutual exclusivity with temperature sensors
                if (currentActive && this.conn && this.conn.handleNestActiveSensorChange) {
                    this.conn.handleNestActiveSensorChange(this.device.device_id, null, 'thermostat');
                }
