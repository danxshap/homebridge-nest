                ...
                if (object) {
                    ...
                    translateProperty(object, 'remote_comfort_sensing_settings', null, (rcsSetting, id) => {
                        ...
                        if (checkDeviceExists(body, id)) {
                            ...
                            try {
                                rcsSensors = value.associatedRcsSensors.map(el => el.deviceId && el.deviceId.resourceId).map(el => 'kryptonite.' + el.split('_')[1]);
                            } catch(error) {
                            ...
                            let activeSensor;
                            if (value.activeRcsSelection && value.activeRcsSelection.rcsSourceType === "RCS_SOURCE_TYPE_SINGLE_SENSOR") {
