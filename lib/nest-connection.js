            ...
            if (property == 'active_rcs_sensors') {
                ...
                if (!!state) {
                    ...
                    if (sensorId !== null) {
                        ...
                        console.log('DEBUG: Setting active sensor to external sensor:', sensorId);
                    } else {
                        body['active_rcs_sensors'] = ["device." + deviceId];
                        console.log('DEBUG: Setting active sensor to thermostat device:', deviceId);
                    }
                ...
                if (protoType == 'type.nestlabs.com/nest.trait.hvac.TargetTemperatureSettingsTrait') {
                    ...
                    if (value && value.length > 0) {
                        ...
                        if (value[0].startsWith('kryptonite.')) {
                            ...
                            console.log('DEBUG PROTOBUF: Setting thermostat as active sensor, deviceId:', deviceOrSensorId);
                            newEl.property.value.activeRcsSelection = {
