        ...
        if (deviceType == 'structure') {
            ...
            if (property == 'active_rcs_sensors') {
                ...
                if (!!state) {
                    ...
                    // Deactivating a sensor - preserve the current schedule control setting
                    // Don't change the user's schedule preference, just change the active sensor
                    ...
                    if (otherActiveSensor) {
                        // Another sensor is active, use it (don't change control mode)
                        body = {
                            active_rcs_sensors: [otherActiveSensor]
                        };
                    } else {
                        // No other sensors active, fall back to thermostat built-in sensor (don't change control mode)
                        body = {
